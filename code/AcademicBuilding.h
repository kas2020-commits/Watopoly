...
class AcademicBuilding: public property{
    ...
    AcademicBuilding( std::string name, std::string blockName, int      improvementCost, int purchaseCost, int tutzero, int tutone, int tuttwo, int tutthree, int tutfour, int tutfive );
